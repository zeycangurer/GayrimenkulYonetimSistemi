...
import GetFlatStatusList from "../services/GetFlatStatusList";
import link from "../services/Links";

function ListFlatStatusContent() {
              ...
              <div className="portlet-body">
                <div className="table-scrollable">
                  <table className="table table-striped table-bordered table-advance table-hover">
                    <GetFlatStatusList btnDelete={btnDelete}/>
                  </table>
                </div>
              </div>
            </div>
...
<![endif]*/}
  ...
  export default ListFlatStatusContent;
