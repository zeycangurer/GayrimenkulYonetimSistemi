...
function FormEmployeeContent() {
    ...
    const btnSubmit = async () => {
      ...
      const response = await axios.post(
        link.PostEmployeeLink, requestBody);
      if (response.status === 200 || 201) {
        window.alert("Yeni kullanıcı girişi başarılı.");
        console.log("Eklendi");
            ...
            <div className="page-content">
                <div className="container">
                    ...
                    <ul className="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <Link to="/formemployee">Çalışan</Link>
                                    ...
                                    <form role="form">
                                        <div className="form-body">
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control" placeholder="Çalışan Adını Giriniz..." id="txtEmployeeName" name="txtEmployeeName" onChange={(e) => setTxtEmployeeName(e.target.value)} required />
                                            </div>
                                            <div className="form-group">
                                                <label>Çalışan Soyadı*</label>
                                                <input type="text" className="form-control" placeholder="Çalışan Soyadını Giriniz..." id="txtEmployeeSurname" name="txtEmployeeSurname" onChange={(e) => setTxtEmployeeSurname(e.target.value)} required />
                                            </div>
                                            <div className="form-group">
                                                ...
                                                <div className="input-group">
                                                    ...
                                                    <input type="text" className="form-control" id="txtUsername" name="txtUsername" placeholder="Kullanıcı Adını Giriniz..." required onChange={(e) => setTxtUsername(e.target.value)} />
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                ...
                                                <div className="input-group">
                                                    ...
                                                    <input type="password" className="form-control" name="txtPassword" id="txtPassword" placeholder="Şifreyi giriniz" onChange={(e) => setTxtPassword(e.target.value)} />
                                                </div>
                                            </div>
                                        </div>
