...
import GetProjectStatusList from "../services/GetProjectStatusList";


function ListProjectStatusContent() {
  ...
  const btnDelete = async (param) => {
    ...
    const response = await axios.delete(
      "https://private-3fc19-insaatapi1.apiary-mock.com/deleteProjectStatus",
      requestBody
    );

    if (response.data.Result == "İşlem başarıyla tamamlandı.") {
      if (window.confirm("Silmek istediğinize emin misiniz?")) {
        window.alert("Proje Durumu Bilgileri Silinmiştir!");
      ...
      <div className="container">
        ...
        <div className="page-toolbar">
          ...
          <div className="btn-group btn-theme-panel">
            <Link to="javascript:;" className="btn dropdown-toggle" data-toggle="dropdown">
    ...
    <div className="page-content">
      <div className="container">
        ...
        <ul className="page-breadcrumb breadcrumb">
          <li>
            <Link to="#">İçerik Yönetimi</Link><i className="fa fa-circle" />
          </li>
          <li>
            <Link to="/listprojectstatus">Proje Durumu</Link>
            ...
            <div className="portlet light">
              <div className="portlet-title">
                <div className="caption">
                  ...
                  <span className="caption-subject font-green-sharp bold uppercase">PROJE DURUMU</span>
                </div>
                <div className="tools">
                  <Link to="javascript:;" className="collapse">
                  </Link>
                  <Link to="#portlet-config" data-toggle="modal" className="config">
                  </Link>
                  <Link to="#" onClick={btnRefresh} className="reload"></Link>
                  <Link to="javascript:;" className="remove">
                  </Link>
                </div>
              </div>
              <div className="portlet-body">
                <div className="table-scrollable">
                  <table className="table table-striped table-bordered table-advance table-hover">
                    <GetProjectStatusList btnDelete={btnDelete}/>
                  </table>
                </div>
              </div>
            </div>
...
<![endif]*/}
  ...
  export default ListProjectStatusContent;
