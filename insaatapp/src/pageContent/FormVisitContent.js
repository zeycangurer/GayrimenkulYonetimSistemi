...
function FormVisitContent() {
    ...
    const btnSubmit = async () => {
        ...
        const response = await axios.post(
         link.PostVisitLink, requestBody);
        if (response.status === 200 || 201) {
          window.alert("Ziyaret Bilgileri Eklendi");
          console.log("Eklendi");
                                    ...
                                    <form role="form">
                                        <div className="form-body">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <GetProjectCmb setCmbProject={setCmbProject} getCmbProject={getCmbProject}/>
                                            </div>
                                            <div className="form-group">
                                                <label>Notlar</label>
...
export default FormVisitContent;