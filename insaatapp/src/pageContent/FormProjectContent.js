...
import GetProjectStatusCmb from "../services/GetProjectStatusCmb";
import axios from "axios";
import React, { useState } from "react";
import { Link } from "react-router-dom";
import link from '../services/Links';

function FormProjectContent() {
    ...
    const btnSubmit = async () => {
      ...
      const response = await axios.post(
        link.PostProjectLink, requestBody);
      if (response.status === 200 || 201) {
        window.alert("Proje Bilgileri Eklendi");
        console.log("Eklendi");
            ...
            <div className="page-content">
                <div className="container">
                    ...
                    <ul className="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <Link to ="/formproject">Proje</Link>
                                    ...
                                    <form role="form">
                                        <div className="form-body">
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control" placeholder="Proje Adını Giriniz..." id="txtName" name="txtName" onChange={(e) => setTxtName(e.target.value)}/>
                                            </div>
                                            <div className="form-group">
                                                <label>Şehir</label>
                                            ...
                                            <div className="form-group">
                                                ...
                                                <GetProjectStatusCmb setCmbStatus={setCmbStatus}/>
                                            </div>
                                        </div>
...
export default FormProjectContent;