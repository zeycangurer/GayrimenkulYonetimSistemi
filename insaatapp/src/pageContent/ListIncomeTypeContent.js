...
import GetIncomeTypeList from "../services/GetIncomeTypeList";


function ListIncomeTypeContent() {
  ...
  const btnDelete = async (param) => {
    ...
    if (response.data.Result == "İşlem başarıyla tamamlandı.") {
      if (window.confirm("Silmek istediğinize emin misiniz?")) {
        window.alert("Gelir Tipi Bilgileri Silinmiştir!");
    ...
    <div className="page-content">
      <div className="container">
        ...
        <ul className="page-breadcrumb breadcrumb">
          ...
          <li>
            <Link to="/listincometype">Gelir Tipi</Link>
            ...
            <div className="portlet light">
              <div className="portlet-title">
                <div className="caption">
                  ...
                  <span className="caption-subject font-green-sharp bold uppercase">GELİR TİPİ</span>
                </div>
                <div className="tools">
              ...
              <div className="portlet-body">
                <div className="table-scrollable">
                  <table className="table table-striped table-bordered table-advance table-hover">
                     ...
                     <GetIncomeTypeList btnDelete={btnDelete}/>
...
<![endif]*/}
  ...
  export default ListIncomeTypeContent;
