...
import GetFlatTypeList from "../services/GetFlatTypeList";


function ListFlatTypeContent() {
  ...
  const btnDelete = async (param) => {
    ...
    const response = await axios.delete(
      "https://private-3fc19-insaatapi1.apiary-mock.com/deleteFlatType",
      requestBody
    );
    ...
    <div className="page-content">
      <div className="container">
        ...
        <ul className="page-breadcrumb breadcrumb">
          ...
          <li>
            <Link to="/listflattype">Daire Tipi</Link>
            ...
            <div className="portlet light">
              <div className="portlet-title">
                <div className="caption">
                  ...
                  <span className="caption-subject font-green-sharp bold uppercase">DAİRE TİPİ</span>
                </div>
                <div className="tools">
              ...
              <div className="portlet-body">
                <div className="table-scrollable">
                  <table className="table table-striped table-bordered table-advance table-hover">
                    <GetFlatTypeList btnDelete={btnDelete}/>
                  </table>
                </div>
              </div>
            </div>
...
<![endif]*/}
  ...
  export default ListFlatTypeContent;
