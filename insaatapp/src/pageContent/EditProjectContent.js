...
function EditProjectContent() {
    ...
    const btnSubmit = async () => {
        let requestBody = {
            ...
            ProjectName: getTxtName,
            CityID: getCmbCity,
            ProjectStatusID: getCmbStatus,
        };
    ...
    useEffect(async () => {
        ...
        const responseProjectStatus = await axios.get(
            link.GetProjectStatusLink
        );

        setProjectStatusData(responseProjectStatus.data[0].ProjectStatusTable);
                            ...
                            <div className="portlet light">
                                <div className="portlet-title">
                                    <div className="caption">
                                        ...
                                        <span className="caption-subject font-green-sharp bold uppercase">PROJE BİLGİLERİ</span>
                                    </div>
                                    <div className="tools">
                                    ...
                                    <form role="form">
                                        <div className="form-body">
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control" placeholder="Proje Adını Giriniz..." id="txtName" name="txtName"
                                                   onChange={(e) => setTxtName(e.target.value)}
                                                   defaultValue={projectData
                                                       .filter(
                                                           (projectItem) =>
                                                               projectItem.ProjectID == searchParam.get("id")
                                                       )
                                                       .map((myArrayItem) => myArrayItem.ProjectName)} required />
                                            </div>
                                            <div className="form-group">
                                                <label>Şehir</label>
                                                <select
                                                        ...
                                                        <option
                                                            ...
                                                            selected={
                                                                projectData
                                                                    .filter(
                                                                        (arrayItem) =>
                                                                            arrayItem.ProjectID == searchParam.get("id")
                                                                    )
                                            ...
                                            <div className="form-group">
                                                ...
                                                >
                                                    {projectStatusData.map((projectStatusItem, index) => (
                                                        <option
                                                            key={index}
                                                            name={projectStatusItem.ProjectStatusName}
                                                            value={projectStatusItem.ProjectStatusID}
                                                            selected={
                                                                projectData
                                                                    .filter(
                                                                        (arrayItem) =>
                                                                    ...
                                                                    .map((arrayItem2) => arrayItem2.ProjectStatusID) ==
                                                                projectStatusItem.ProjectStatusName
                                                            }
                                                        >
                                                            {projectStatusItem.ProjectStatusName}
                                                        </option>
