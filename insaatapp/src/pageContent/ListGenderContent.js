...
import GetGenderList from "../services/GetGenderList";

function ListGenderContent() {
  ...
  const btnDelete = async (param) => {
    ...
    const response = await axios.delete(
      "https://private-3fc19-insaatapi1.apiary-mock.com/deleteGender",
      requestBody
    );

    if (response.data.Result == "Silme işlemi tamamlandı.") {
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              ...
              <li>
                <Link to="/listgender">Cinsiyet</Link>
                <i className="fa fa-circle" />
              </li>
              ...
              <div className="col-md-12">
                ...
                <div className="portlet light">
                  <div className="portlet-title">
                    ...
                    <div className="tools">
                      <Link to="javascript:;" className="collapse"></Link>
                      <Link
                        to="#portlet-config"
                        data-toggle="modal"
                        className="config"
                      ...
                      <Link to="javascript:;" className="remove"></Link>
                    </div>
                  </div>
                  <div className="portlet-body">
                    <div className="table-scrollable">
                      <table className="table table-striped table-bordered table-advance table-hover">
                        <GetGenderList btnDelete={btnDelete}/>
                      </table>
                    </div>
                  </div>
                </div>
...
export default ListGenderContent;
