...
import GetCustomerCmb from "../services/GetCustomerCmb";
import GetEmployeeCmb from "../services/GetEmployeeCmb";
import GetFlatCmb from "../services/GetFlatCmb";
import link from '../services/Links';

function FormSaleContent() {
    const [getDtSalesDate,setDtSalesDate] = useState();
    const [getTxtPrice,setTxtPrice] = useState();
    const [getTxtNotes,setTxtNotes] = useState();
    const [getCmbCustomer, setCmbCustomer] = useState();
    const [getCmbEmployee, setCmbEmployee] = useState();
    const [getCmbFlat, setCmbFlat] = useState();
    const btnSubmit = async () => {
        let requestBody = {
          SalesDate: getDtSalesDate,
          Price: getTxtPrice,
          Notes: getTxtNotes,
          CustomerID: getCmbCustomer,
          EmployeeID: getCmbEmployee,
          FlatID: getCmbFlat
        };
    
        const response = await axios.post(
          link.PostSaleLink, requestBody);
        if (response.status === 200 || 201) {
          window.alert("Satış Bilgileri Eklendi");
          console.log("Eklendi");
                            ...
                            <div className="portlet light">
                                <div className="portlet-title">
                                    <div className="caption">
                                        ...
                                        <span className="caption-subject font-green-sharp bold uppercase">SATIŞ BİLGİLERİ</span>
                                    </div>
                                    <div className="tools">
                                    ...
                                    <form role="form">
                                        <div className="form-body">
                                            <div className="form-group">
                                                ...
                                                <input type="date" className="form-control" id="dtSalesDate" name="dtSalesDate" onChange={(e) => setDtSalesDate(e.target.value)} required />
                                            </div>
                                            <div className="form-group">
                                                <label>Müşteri</label>
                                                <GetCustomerCmb setCmbCustomer={setCmbCustomer} getCmbCustomer={getCmbCustomer}  />
                                            </div>
                                            <div className="form-group">
                                                <label>Daire</label>
                                                <GetFlatCmb setCmbFlat={setCmbFlat} getCmbFlat={getCmbFlat}/>
                                            </div>
                                        </div>
                                        <div className="form-group">
                                            <label>Fiyat</label>
                                        ...
                                        <div className="form-group">
                                            <label>Çalışan</label>
                                            <GetEmployeeCmb setCmbEmployee={setCmbEmployee} getCmbEmployee={getCmbEmployee}/>
                                        </div>
                                        <div className="form-group">
                                            <label>Notlar</label>
                                            <textarea className="form-control" rows={3} id="txtNotes" name="txtNotes" defaultValue={""} onChange={(e) => setTxtNotes(e.target.value)} />
                                        </div>
...
export default FormSaleContent;